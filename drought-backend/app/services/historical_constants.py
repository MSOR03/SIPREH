...
VARIABLE_CLASS_SCALES = {
   "pet": {
        ...
        "categories": [
            {"label": "Muy baja", "color": "#4575B4", "severity": 0},
            {"label": "Baja", "color": "#74ADD1", "severity": 1},
            {"label": "Media-baja", "color": "#E0F3F8", "severity": 2},
    ...
    "tmax": {
     ...
     "precip": {
        "D": {
            ...
            "categories": [
                {"label": "Muy baja", "color": "#D7191C", "severity": 0},
                {"label": "Baja", "color": "#FDAE61", "severity": 1},
                {"label": "Media-baja", "color": "#FFFFBF", "severity": 2},
                {"label": "Media-alta", "color": "#A1D99B", "severity": 3},
                {"label": "Alta", "color": "#74ADD1", "severity": 4},
                {"label": "Muy alta", "color": "#4575B4", "severity": 5},
            ],
        },
        "M": {
