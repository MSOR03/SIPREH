...
import { RotateCcw, Download, MapPin, ChevronLeft, ChevronRight, Home, Layers, Grid3x3, Navigation, Droplets, Database, Map } from 'lucide-react';
            ...
            {layerMenuOpen && (
              <div className="absolute top-full left-0 mb-2 w-56 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-xl border border-gray-200 dark:border-gray-600 p-2 space-y-1 animate-fade-in">
                ...
                {[
                  ...
                  { key: 'boundary', label: 'Límite área de estudio', icon: Map, color: 'text-gray-500' },
