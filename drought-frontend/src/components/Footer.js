...
import { FileText, Users, Book, Cloud } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20 dark:opacity-10 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-64 h-64 bg-blue-400 dark:bg-blue-500 rounded-full blur-3xl animate-pulse" />
        <div
          className="absolute bottom-0 right-1/4 w-64 h-64 bg-indigo-400 dark:bg-purple-500 rounded-full blur-3xl animate-pulse"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-5 animate-slide-down">
            <div className="relative group">
              ...
              <div className="relative p-3 bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-800 rounded-xl shadow-xl border border-blue-300/50 dark:border-blue-400/30">
          ...
          <div className="flex items-center gap-8 text-sm animate-fade-in">
            {[
              { icon: FileText, label: 'Condiciones de Uso' },
              { icon: Users,    label: 'Créditos'          },
              { icon: Book,     label: 'Documentación'     },
            ].map(({ icon: Icon, label }) => (
              <a
                key={label}
                href="#"
